...
namespace DNTProfiler.UnparametrizedWhereClauses.ViewModels
{
        ...
        private void Commands_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    ...
                    {
                        _callbacksManager.RunAnalysisVisitorOnCommand(new UnparametrizedWhereClausesVisitor(), command);
                    }
                    break;
            }
        }
