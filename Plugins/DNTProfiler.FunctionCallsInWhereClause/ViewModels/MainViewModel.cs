...
namespace DNTProfiler.FunctionCallsInWhereClause.ViewModels
{
        ...
        private void Commands_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    ...
                    {
                        _callbacksManager.RunAnalysisVisitorOnCommand(new FunctionCallsInWhereClauseVisitor(), command);
                    }
                    break;
            }
        }
