...
namespace DNTProfiler.Common.Logger
{
    public class ExceptionLogger : IExceptionLogger
    {
        ...
        public string GetExceptionMessageStack(Exception e)
        {
        ...
        public void LogExceptionToFile(object exception, string fileName)
        {
            if (exception == null || string.IsNullOrWhiteSpace(fileName))
                return;
